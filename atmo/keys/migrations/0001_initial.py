    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(help_text=b'User that created the instance.', on_delete=django.db.models.deletion.CASCADE, related_name='created_sshkeys', to=settings.AUTH_USER_MODEL)),
            ],
            options={
